let bgColorBtn = document.querySelector("#bgColorBtn") as HTMLButtonElement;
let colorsNum = document.querySelector("#colorsNum") as HTMLInputElement;
let colorWrapper = document.querySelector("#colorWrapper") as HTMLDivElement;
...
function appendColorElement(color: string) {
