  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen relative overflow-hidden">
      ...
      <p className="text-xl text-gray-700 mt-4 z-10 text-pink-600 text-center p-4 lg:w-[32rem]">
        💖 "तूच माझ्या आयुष्याचा गोडवा, माझ्या हृदयाची शांती, आणि माझ्या
        प्रत्येक हसूचं कारण आहेस. तुझ्या प्रेमाशिवाय हे जीवन अपूर्ण आहे.
        तुझ्यासोबत प्रत्येक दिवस एक सुंदर स्वप्न साकार झाल्यासारखा वाटतो. तूच
        माझं हृदय, माझं आनंद आणि माझं सदैव असशील. तुला शब्दांपेक्षा जास्त प्रेम
        करतो!" 💖
      </p>
    </div>
  );
